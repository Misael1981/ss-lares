  ...
  try {
    ...
    const products = [
      ...
      },
      {
        ...
        // Dimensões da CAIXA
        quantityPackages: "50",
        quantityOfUnitsInPackages: "50 peças",
        boxHeight: "50cm",
        boxWidth: "45cm",
        boxLength: "40cm",
        boxWeight: "7.670",
        ...
        width: "25mm",
        length: "25mm",
        tags: ["espacador", "acentamento de pisos", "nivelador de pisos"],
        isAvailable: true,
      },
      {
        name: "Espaçador Smart 1,5mm",
        slug: "espacador-slim-padrao",
        description:
          "O Espaçador Nivelador SSLARES garante espaçamento e auxilia a Cunha Niveladora Slim a nivelar os pisos corretamente. Com as duas funções simultâneas agiliza o processo de assentamento dos pisos, reduzindo em até 50% o tempo de colocação. Medidas disponíveis 3 mm, 2 mm, 1,5 mm e 1 mm. Trabalhamos na versão PADRÃO (material reciclado cor cinza) e PREMIUM (material virgem cristal).",
        type: "espaçadores",
      ...
      },
      {
        ...
        // Dimensões da CAIXA
        quantityPackages: "25",
        quantityOfUnitsInPackages: "100 peças",
        boxHeight: "50cm",
        boxWidth: "45cm",
        boxLength: "40cm",
        boxWeight: "7.555",
      ...
      },
      {
        ...
        // Dimensões da CAIXA
        quantityPackages: "6",
        quantityOfUnitsInPackages: "500 peças",
        boxHeight: "50cm",
        boxWidth: "45cm",
        boxLength: "40cm",
        boxWeight: "9.144",
      ...
      {
        name: "Espaçador Slim Premium 1.0mm",
      ...
      {
        name: "Espaçador Slim Premium 1.5mm",
        slug: "espacador-slim-premium",
        description:
          "O Espaçador Nivelador SSLARES garante espaçamento e auxilia a Cunha Niveladora Slim a nivelar os pisos corretamente. Com as duas funções simultâneas agiliza o processo de assentamento dos pisos, reduzindo em até 50% o tempo de colocação. Medidas disponíveis 3 mm, 2 mm, 1,5 mm e 1 mm. Trabalhamos na versão PADRÃO (material reciclado cor cinza) e PREMIUM (material virgem cristal).",
        type: "espaçadores",
      ...
      {
        name: "Espaçador Slim Premium 2.0mm",
        slug: "espacador-slim-premium",
        description:
          "O Espaçador Nivelador SSLARES garante espaçamento e auxilia a Cunha Niveladora Slim a nivelar os pisos corretamente. Com as duas funções simultâneas agiliza o processo de assentamento dos pisos, reduzindo em até 50% o tempo de colocação. Medidas disponíveis 3 mm, 2 mm, 1,5 mm e 1 mm. Trabalhamos na versão PADRÃO (material reciclado cor cinza) e PREMIUM (material virgem cristal).",
        type: "espaçadores",
      ...
      {
        name: "Espaçador Slim Premium 3.0mm",
        slug: "espacador-slim-premium",
        description:
          "O Espaçador Nivelador SSLARES garante espaçamento e auxilia a Cunha Niveladora Slim a nivelar os pisos corretamente. Com as duas funções simultâneas agiliza o processo de assentamento dos pisos, reduzindo em até 50% o tempo de colocação. Medidas disponíveis 3 mm, 2 mm, 1,5 mm e 1 mm. Trabalhamos na versão PADRÃO (material reciclado cor cinza) e PREMIUM (material virgem cristal).",
        type: "espaçadores",
      ...
      },
      {
        ...
        type: "ralos",
        color: ["bege", "branco", "cinza", "marrom", "preto"],
        price: 20.0,
        weight: "320",
        // Dimensões da CAIXA
        quantityPackages: "1",
        quantityOfUnitsInPackages: "36 peças",
        boxHeight: "41cm",
        boxWidth: "41cm",
        boxLength: "52cm",
        boxWeight: "11.700",
      ...
      },
      {
        ...
        type: "ralos",
        color: ["branco", "cinza claro", "cinza escuro", "preto"],
        price: 20.0,
        weight: "99",
        // Dimensões da CAIXA
        quantityPackages: "1",
        quantityOfUnitsInPackages: "150 peças",
        boxHeight: "51cm",
        boxWidth: "38cm",
        boxLength: "55cm",
        boxWeight: "15.230",
